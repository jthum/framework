...
/** Translate a portable Rule into the authoring interface's key-oriented working model. */
...
/** Translate the authoring working model to the canonical, identity-based Rule contract. */
