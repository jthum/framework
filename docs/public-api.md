...
| `@jthum/framework/svelte/studio/settings-layout` | Host-defined settings layout and typed value helpers    | [`src/svelte/studio/settings-layout.ts`](../src/svelte/studio/settings-layout.ts) | [`src/svelte/studio/settings-layout.spec.ts`](../src/svelte/studio/settings-layout.spec.ts) |
