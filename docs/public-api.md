...
| `@jthum/framework-sqlite-browser`                  | Optional wa-sqlite/OPFS browser driver                  | [`packages/sqlite/browser/src`](../packages/sqlite/browser/src)                                   | package tests, package build, and host production build                                         |
| `@jthum/yair`                                      | Optional provider-neutral inference and tool loop       | [`packages/inference/yair/core/src`](../packages/inference/yair/core/src)                         | package protocol tests and package build                                                        |
| `@jthum/yair-openai`                               | Optional OpenAI-compatible YAIR provider                | [`packages/inference/yair/providers/openai/src`](../packages/inference/yair/providers/openai/src) | deterministic provider tests, package build, and opt-in live contract                           |
...
| `@jthum/framework/svelte/authoring`                | Aggregate authoring barrel; intentionally eager         | [`src/svelte/authoring/index.ts`](../src/svelte/authoring/index.ts)                               | authoring rendering and boundary tests                                                          |
| `@jthum/framework/svelte/authoring/*`              | Granular, code-splittable authoring components          | [`src/svelte/authoring`](../src/svelte/authoring)                                                 | focused component and adapter tests                                                             |
| `@jthum/framework/svelte/authoring/adapters`       | Canonical authoring adapters                            | [`src/svelte/authoring/adapters.ts`](../src/svelte/authoring/adapters.ts)                         | adapter round-trip tests                                                                        |
| `@jthum/framework/svelte/authoring/data`           | Authoring working models and context helpers            | [`src/svelte/authoring/data.ts`](../src/svelte/authoring/data.ts)                                 | editor-context tests                                                                            |
| `@jthum/framework/svelte/operations`               | Execution and ActorRequest surfaces                     | [`src/svelte/operations/index.ts`](../src/svelte/operations/index.ts)                             | operations rendering and boundary tests                                                         |
| `@jthum/framework/svelte/operations/*`             | Granular, code-splittable operations components         | [`src/svelte/operations`](../src/svelte/operations)                                               | focused operations rendering tests                                                              |
| `@jthum/framework/svelte/settings`                 | Reusable settings surfaces                              | [`src/svelte/settings/index.ts`](../src/svelte/settings/index.ts)                                 | settings rendering and boundary tests                                                           |
| `@jthum/framework/svelte/settings/settings-layout` | Host-defined settings layout and typed value helpers    | [`src/svelte/settings/settings-layout.ts`](../src/svelte/settings/settings-layout.ts)             | [`src/svelte/settings/settings-layout.spec.ts`](../src/svelte/settings/settings-layout.spec.ts) |
| `@jthum/framework/svelte/settings/*`               | Granular, code-splittable settings components           | [`src/svelte/settings`](../src/svelte/settings)                                                   | focused settings rendering tests                                                                |
...
| UI/transport boundary            | `WorkspaceClient`, `WorkspaceManagementClient`, `ActorClient`, `MembershipClient`, `AttachmentClient`, `ScopeClient` | [`src/client/workspace-client.ts`](../src/client/workspace-client.ts) |
...
| Record port                      | `RecordStore`, `CollectionRecord`, `RecordValues`, `RecordQueryResult`, `RecordQueryRelation`                        | [`src/persistence/records.ts`](../src/persistence/records.ts)         |
...
- Svelte integration boundaries: [`src/svelte/svelte-boundaries.test.ts`](../src/svelte/svelte-boundaries.test.ts)
